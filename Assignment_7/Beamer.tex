...
\end{align}
Substituting equations \eqref{eqn1}, \eqref{eqn2} in equation \eqref{eqconv} we get 
\begin{align}
    k_1k_2&=-12
\end{align}
Possible combinations of ($k_1,k_2$) are (6,-2), (-6,2), (3,-4), (-3,4)
...
\end{align}
Solving equations \eqref{eqsol1} ,\eqref{eqsol2} we get 
\begin{align}
    c_1&=-5\\
    c_2&=7
\end{align}
