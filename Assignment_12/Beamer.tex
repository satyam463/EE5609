...
\end{align}
From the reduced form of the augmented matrox we can see that it has only trivial solutions $x_1=x_2=0$. Hence proved, the equation $\vec{AX}$=0 has only one trivial solution $x_1=x_2=0$
\subsection{Solution 3}
Let, $a$ is the nonzero entry of $\vec{A}$. Given $ad-bc=0$, we can perform row reduction on augmented matrix of equation $\vec{AX}=0$ as follows,
\begin{align}
\myvec{a&b&0\\c&d&0}&\xleftrightarrow{R_1 = \frac{1}{a}R_1}\myvec{1&\frac{b}{a}&0\\c&d&0}\\
