...
1+1+\dots+1 = n &\not= 0\label{eq3}
\end{align}
From the definition of characteristic of a field and from \eqref{eq1}, \eqref{eq2} and so on up-to \eqref{eq3}, the rational number field, $\mathbb{Q}$ has characteristic 0.\\
